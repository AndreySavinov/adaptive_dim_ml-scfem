...
if sn == 0
    ...
    fprintf('8.  Mommer-Stevenson based Examples \n')
    fprintf('Or have a look into goafem_stochcol_qtychoice.m for other choices \n')
    %fprintf('9.x. Variable RHS \n')
    % 9.1. Quadratic variable RHS
    % 9.2. Exponential variable RHS   
...
switch QOI_type
    ...
    case 4 % Non-linear (square of convection term in sub-domain) 
